...
set psu_clock_init_data {
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01011800U)  */
    mask_write 0XFF5E00C4 0x013F3F07 0x01011800
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
    ...
    mask_write 0XFD1A0080 0x00003F07 0x00000800
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070024 0xFFFFFFFF 0x001AB3F0
    ...
    mask_write 0XFD070034 0x00FFFF1F 0x00402C10
    ...
    mask_write 0XFD070064 0x0FFF83FF 0x00058020
    ...
    mask_write 0XFD0700D0 0xC3FF0FFF 0x00020157
    ...
    mask_write 0XFD0700D4 0x01FF7F0F 0x00240000
    ...
    mask_write 0XFD070110 0x1F0F0F1F 0x0A040307
    ...
    mask_write 0XFD070180 0xF7FF03FF 0x80AF0006
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x0092160E
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F006C0
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x15E0AF10
    ...
    mask_write 0XFD080044 0xFFFFFFFF 0x445C0627
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00171308
    ...
    mask_write 0XFD080680 0xFFFFFFFF 0x0088EC58
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x51000400
...
mwr -force  0xFD080018 0x00F053C0
...
poll 0xFD080030 0x00004001 0x00004001
 ...
 #//Poll PUB_PGSR0 for Trng complete  
mwr -force  0xFD080200 0x800091C7
mwr -force  0xFD080018 0x00F05E6A
...
poll 0xFD080030 0x00000C01 0x00000C01
 ...
 #//Poll PUB_PGSR0 for Trng complete  
mwr -force  0xFD070180 0x00AF0006
